...
const MyWork = () => {
  ...
  const backgroundCircles = Array.from({ length: 20 }, (_, i) => ({
    id: i,
      ...
      <div className="h-full w-full bg-gradient-to-br from-blue-950 via-cyan-900 to-slate-900 overflow-y-auto">
        ...
        <div className="relative z-10 px-4 py-8">
          ...
          <motion.div
            ...
            className="text-center p-6 rounded-2xl bg-gradient-to-br from-blue-900/50 to-cyan-900/30 backdrop-blur-lg border border-cyan-500/20"
          >
            ...
            <div className="flex justify-center gap-4">
              {["GitHub", "LinkedIn", "Twitter"].map((platform) => (
                <motion.a
                  ...
                  whileHover={{ y: -3 }}
                  href="#"
                  className="px-4 py-2 rounded-full bg-cyan-500/10 text-cyan-100 hover:bg-cyan-500/20 transition-colors"
                >
                  {platform}
                </motion.a>
              ))}
