        ...
        <div className="flex-1 overflow-hidden">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="h-full"
            >
              <div className="relative p-6 inset-0 bg-gradient-to-br from-cyan-500/5 via-emerald-500/5 to-orange-500/5 rounded-2xl backdrop-blur-xl border border-white/10 h-full overflow-y-scroll">
