  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <p className="text-gray-600 text-center mb-8">
        Welcome to my portfolio of software projects! Currently, I’m focused on
        contributing to TSCircuit, an open-source project, with plans to add
        more projects as I grow my skills and experience.
      </p>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg mb-8">
        ...
        <p className="text-gray-600 mt-1">
          ...
          with the community to ensure a smooth user experience.
        </p>
